...
def display_menu_expanded():
    ...
    if table_data:
        ...
        st.dataframe(
            ...
            column_config={
                "日期": st.column_config.TextColumn(width=80),
                "餐次": st.column_config.TextColumn(width=60),
                "菜品": st.column_config.TextColumn(width=150),
                "所需食材": st.column_config.TextColumn(width=400),
            }
        )
